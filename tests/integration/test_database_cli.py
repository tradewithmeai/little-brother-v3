...
class TestDatabaseRoundTrip:
    ...
    def test_event_roundtrip(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            key_fields = [
                'id', 'ts_utc', 'monitor', 'action', 'subject_type',
                'session_id', 'exe_name', 'exe_path_hash', 'window_title_hash'
            ]
            
            for field in key_fields:
                assert retrieved_event[field] == original_event[field], f"Field {field} mismatch"
    ...
    def test_multiple_events_ordering(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            for i in range(len(retrieved_events) - 1):
                assert retrieved_events[i]['ts_utc'] >= retrieved_events[i + 1]['ts_utc']
    ...
    def test_session_and_event_relationship(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            events = db.get_events_by_timerange(current_time - 5000, current_time + 5000)
