...
class TestSpoolerImporterIntegration:
    ...
    def test_end_to_end_workflow(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                ...
                assert stats["total_events_imported"] == len(monitors) * events_per_monitor
    ...
    def test_concurrent_spooler_access(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            threads = []
            for i, monitor in enumerate(["monitor1", "monitor2", "monitor3"]):
    ...
    def test_multiple_file_rollover(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                ...
                events = db.get_events_by_timerange(0, int(time.time() * 1000) + 1000, limit=total_events)
...
class TestSpoolerCLIIntegration:
    ...
    def test_cli_generate_and_flush(self):
        ...
        result = subprocess.run(
            ["python", "-m", "lb3", "spool", "generate", "active_window", "--count", "5"],
