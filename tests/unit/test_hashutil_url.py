...
class TestURLHashing:
    ...
    def test_extract_domain(self):
        ...
        assert (
            extract_domain("https://subdomain.example.com:8080/")
        ...
        assert (
            extract_domain("https://api.example.com:443/v1/users")
            == "api.example.com:443"
        )
    ...
    def test_hash_determinism_across_sessions(self):
        ...
        for url, expected_domain in test_cases:
            ...
            assert (
                len(set(domain_hashes)) == 1
            ), f"Domain hashing not deterministic for {expected_domain}"
