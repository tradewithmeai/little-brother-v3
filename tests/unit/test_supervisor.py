...
class TestMonitorSupervisor:
    ...
    def test_start_all_success(self, mock_spooler_sink_class, mock_get_event_bus):
        ...
        supervisor._monitor_status = {
            "monitor1": {"name": "monitor1", "monitor": mock_monitor1, "started": False, "error": None},
            "monitor2": {"name": "monitor2", "monitor": mock_monitor2, "started": False, "error": None}
        }
    ...
    def test_start_all_dry_run_no_event_bus(self):
        ...
        supervisor._monitor_status = {
            "monitor1": {"name": "monitor1", "monitor": mock_monitor, "started": False, "error": None}
        }
    ...
    def test_start_all_monitor_failure(self):
        ...
        supervisor._monitors = [mock_monitor1, mock_monitor2]
        supervisor._monitor_status = {
            "failing_monitor": {"name": "failing_monitor", "monitor": mock_monitor1, "started": False, "error": None},
            "working_monitor": {"name": "working_monitor", "monitor": mock_monitor2, "started": False, "error": None}
        }
    ...
    def test_stop_all(self):
        ...
        supervisor._monitor_status = {
            "monitor1": {"name": "monitor1", "monitor": mock_monitor1, "started": True, "error": None},
            "monitor2": {"name": "monitor2", "monitor": mock_monitor2, "started": True, "error": None}
        }
    ...
    def test_wait_for_threads_timeout(self):
        ...
        supervisor._monitor_status = {
            "hanging_monitor": {"name": "hanging_monitor", "monitor": mock_monitor, "started": True, "error": None}
        }
    ...
    def test_wait_until_shutdown_monitors_finished(self):
        ...
        supervisor._monitor_status = {
            "monitor1": {"name": "monitor1", "monitor": mock_monitor, "started": True, "error": None}
        }
    ...
    def test_signal_handler_setup(self):
        ...
        with patch('signal.signal') as mock_signal:
            ...
            sigterm_calls = [call for call in mock_signal.call_args_list if call[0][0] == signal.SIGTERM]
...
class TestCreateStandardSupervisor:
    ...
    def test_create_standard_supervisor_dry_run(self, *mock_monitors):
        ...
        status = supervisor.get_monitor_status()
        expected_monitors = {"heartbeat", "context", "keyboard", "mouse", "file", "browser"}
