...
class TestDatabaseConstraints:
    ...
    def test_unix_timestamp_storage(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            events = db.get_events_by_timerange(current_time_ms - 1000, current_time_ms + 1000)
            assert len(events) == 1
...
class TestCreateTestEvent:
    ...
    def test_create_test_event_structure(self):
        ...
        required_fields = [
            ...
            'session_id', 'exe_path_hash', 'window_title_hash'
        ]
        ...
        assert event['monitor'] in ['active_window', 'context_snapshot', 'keyboard', 'mouse', 'browser', 'file']
