...
class BrowserConfig(BaseModel):
    ...
    integration: BrowserIntegrationConfig = Field(default_factory=BrowserIntegrationConfig)
...
class BatchConfig(BaseModel):
    ...
    flush_thresholds: FlushThresholdsConfig = Field(default_factory=FlushThresholdsConfig)
