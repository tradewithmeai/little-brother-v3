    ...
    metrics = [
        {
            ...
            "description": "Total minutes of focused foreground activity within the hour/day",
            "unit": "minutes",
            "version": 1,
        },
        {
            "metric_key": "idle_minutes",
            "description": "Minutes with no meaningful activity (derived from focus gaps)",
            "unit": "minutes",
            "version": 1,
        },
        {
        ...
        },
        {
            ...
            "description": "Foreground app/window switches",
            "unit": "count",
            "version": 1,
        },
        {
