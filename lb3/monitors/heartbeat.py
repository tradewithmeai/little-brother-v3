...
class HeartbeatMonitor(MonitorBase):
    ...
    def __init__(self, dry_run: bool = False, interval: float = 1.0, total_beats: int = 10):
    ...
    def start_monitoring(self) -> None:
        ...
        self.logger.info(f"Starting heartbeat monitor (interval: {self.interval}s, total: {self.total_beats})")
        self._beat_count = 0
    ...
    def _run_loop(self) -> None:
        ...
        try:
            ...
            try:
                ...
                self.logger.error(f"Error stopping heartbeat monitor: {e}", exc_info=True)
