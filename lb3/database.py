...
class Database:
    ...
    def _create_schema(self, conn: sqlite3.Connection) -> None:
        ...
        CREATE TABLE IF NOT EXISTS events(
            ...
            monitor TEXT NOT NULL CHECK(monitor IN ('active_window','context_snapshot','keyboard','mouse','browser','file')),
    ...
    def get_events_by_timerange(self, start_utc: int, end_utc: int, limit: int = 1000) -> List[Dict[str, Any]]:
